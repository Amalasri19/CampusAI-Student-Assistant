CampusAI – Student Assistant Chatbot 🎓🤖
...
* How does the placement cell work?
* What are the college timings?
The chatbot analyzes the question and provides the most relevant answer.
⚙️ Installation & Setup
1️ Clone the repository
git clone https://github.com/Amalasri19/CampusAI-Student-Assistant.git
2️ Navigate to the project folder
cd CampusAI-Student-Assistant
...
* Store chat history
* Deploy chatbot online for public access
